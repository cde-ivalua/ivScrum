...
const teams = [
    {
        ...
        "devs":
        {
            ...
            'jgi': {'trigram' : 'jgi', 'name': 'Jules', 'trello':  getBoolFromStorage('jgi'), 'present' : getBoolFromStorage('jgi'), 'tab' : null, 'done' : false, 'time' : 0 },
            ...
            'rpa': {'trigram' : 'rpa', 'name': 'Rajendra', 'present' : getBoolFromStorage('rpa'), 'tab' : null, 'done' : false, 'time' : 0 },
