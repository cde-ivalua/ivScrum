...
const teams = [
    {
        ...
        "devs":
        {
            ...
            'mif': {'trigram' : 'mif', 'name': 'Mohamed', 'present' : getBoolFromStorage('mif'), 'tab' : null, 'done' : false, 'time' : 0 },
            'npe': {'trigram' : 'npe', 'name': 'Nikola', 'present' : getBoolFromStorage('npe'), 'tab' : null, 'done' : false, 'time' : 0 },
