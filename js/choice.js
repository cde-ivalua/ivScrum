...
const teams = [
    {
        ...
        "devs":
        {
            ...
            'mif': {'trigram' : 'mif', 'name': 'Iheb', 'present' : getBoolFromStorage('mif'), 'tab' : null, 'done' : false, 'time' : 0 },
            ...
            'npe': {'trigram' : 'npc', 'name': 'Nikola', 'present' : getBoolFromStorage('npc'), 'tab' : null, 'done' : false, 'time' : 0 },
